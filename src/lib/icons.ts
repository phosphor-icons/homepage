...
export const icons: Readonly<IconEntry[]> = [
  ...
  //   categories: [IconCategory.OTHER],
  //   tags: ["directional", "pointer", "pointing", "arrowhead", "undo", "return", "backwards", "u-turns"],
  //   Icon: Icon.ArrowUDownLeft,
  // },
  // {
  //   name: "arrow-u-down-right",
  //   categories: [IconCategory.OTHER],
  //   tags: ["directional", "pointer", "pointing", "arrowhead", "redo", "forwards", "u-turns"],
  ...
  //   categories: [IconCategory.OTHER],
  //   tags: ["directional", "pointer", "pointing", "arrowhead", "redo", "refreshing"],
  ...
  //   name: "arrows-outward",
  //   categories: [IconCategory.OTHER],
  //   tags: ["directional", "pointer", "pointing", "arrowhead", "expand", "fullscreen"],
  //   Icon: Icon.ArrowsOutward,
  // },
  // {
  //   name: "arrows-outward-cardinal",
  //   categories: [IconCategory.OTHER],
  //   tags: ["directional", "pointer", "pointing", "arrowhead", "expand", "fullscreen", "pan"],
