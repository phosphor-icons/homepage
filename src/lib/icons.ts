...
export const icons: ReadonlyArray<IconEntry> = [
  ...
  //   name: "calendar-check",
  //   categories: [IconCategory.OFFICE, IconCategory.SYSTEM],
  //   tags: ["*new*", "dates", "times", "events", "schedule", "todo", "checklist"],
  ...
  //   tags: ["*new*", "animals", "pets", "food", "seafood", "restaurants", "dining"],
  //   Icon: Icons.Fish,
  // },
  // {
  //   name: "fish-simple",
  ...
  //   tags: ["*new*", "vcs", "source control", "version control", "versioning", "branches"],
  ...
  //   categories: [IconCategory.PEOPLE],
  //   tags: ["*new*", "license", "credentials", "nametag", "user", "verification"],
